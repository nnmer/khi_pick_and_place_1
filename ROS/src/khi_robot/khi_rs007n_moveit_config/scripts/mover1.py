...
print("loading khi_rs007n_moveit_config:mover.py")
...
def plan_trajectory(move_group, destination_pose, start_joint_angles): 
    print("khi_rs007n_moveit_config:mover.py:plan_trajectory")
...
def plan_pick_and_place(req):
    print("khi_rs007n_moveit_config:mover.py:plan_pick_and_place")
    print("    req:",req)
...
def moveit_server():
    ...
    print("khi_rs007n_moveit_config:mover.py:Ready to plan - spinning")
    rospy.spin()
